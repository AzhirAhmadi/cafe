class AvatarUploader < CarrierWave::Uploader::Base
  ...
  def store_dir
    "uploads/#{ model.parent.class.to_s.underscore}s/#{mounted_as}/#{model.parent.id}"
  end
  ...
  def filename
    ...
    "img#{secure_token}.#{file.extension}" if original_filename
    # "img1234."+original_filename.split('.')[1] if original_filename
  end
