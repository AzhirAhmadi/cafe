...
RSpec.describe EventsController, type: :request do
    describe ".show" do
        context "when loged in az sys_expert" do
            ...
            it "shloud see locked event in coffee_shop if sys_expert is the maintainer of coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
            ...
            it "shloud not see locked event in coffee_shop if sys_expert is not the maintainer of coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
    ...
    describe ".create" do
        context "when loged in az sys_expert" do
            it "shloud create event if sys_expert is maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
            ...
            it "shloud not create event if sys_expert is not maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
    ...
    describe ".update" do
        context "when loged in az sys_expert" do
            ...
            it "shloud not update event if sys_expert is not maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
    ...
    describe ".destroy" do
        context "when loged in az sys_expert" do
            ...
            it "shloud not deactivate event if sys_expert is not maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
