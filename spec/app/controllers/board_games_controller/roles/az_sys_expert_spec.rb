...
RSpec.describe BoardGamesController, type: :request do
    ...
    describe ".create" do
        context "when loged in az sys_expert" do
            it "shloud create board_game if sys_expert is maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
            ...
            it "shloud not create board_game if sys_expert is not maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
    ...
    describe ".deactivate" do
        context "when loged in az player" do
            ...
            it "shloud not deactivate board_game if sys_expert is not maintainer of the coffee_shop" do
                sys_expert = create :sys_expert
                login sys_expert
                headers = {"Authorization": JSON.parse(response.body)["jwt"]}
